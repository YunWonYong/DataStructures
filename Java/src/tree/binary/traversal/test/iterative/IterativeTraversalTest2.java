...
public class IterativeTraversalTest2 {
	...
	public static void setUp() throws Exception {
		Node<Integer> leftChildNode = new Node<>(null, 1, new Node<>(null, 2, null));
	...
	public void iterativePreOrderTraversal() {
		...
		assertEquals("3, 1, 2, 5, 4", ITERATIVE_TRAVERSAL.flush());
	}
	...
	public void iterativePostOrderTraversal() {
		...
		assertEquals("2, 1, 4, 5, 3", ITERATIVE_TRAVERSAL.flush());
	}
